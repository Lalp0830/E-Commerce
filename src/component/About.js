            ...
            <div className="container py-5 my-5">
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <p className={`lead mb-4 text-${props.mode == 'light' ? 'dark' : 'light'}`}>
                        ...
                        <NavLink to={process.env.REACT_APP_BASE_URL+'/contact'} className="btn btn-outline-primary px-3">Contact Us</NavLink>
                    </div>
